...
const Chatbot: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'model', text: 'Hello! I am your EVWorld AI assistant. How can I optimize your logistics today?' }
  ]);
  ...
  const handleSend = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        contents: history,
        config: {
          systemInstruction: "You are an expert logistics AI assistant for EVWorld Pro, a logistics and delivery management system. You help users understand features like Shipment Tracking, Route Planning, Billing, and Incident Reporting. You are professional, concise, and helpful.",
        }
      });
        ...
        <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-80 sm:w-96 flex flex-col mb-4 border border-slate-200 dark:border-slate-700 overflow-hidden animate-in slide-in-from-bottom-10 fade-in duration-200 transition-colors">
          ...
          <div className="bg-slate-50 dark:bg-slate-950 p-4 flex justify-between items-center shadow-lg border-b border-slate-200 dark:border-slate-800">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-sm text-slate-900 dark:text-white">EVWorld AI</h3>
