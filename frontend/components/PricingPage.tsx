...
const PricingPage: React.FC = () => {
  ...
  const destinations = getItems<DestinationRecord>('destinations') || []; // Assuming 'destinations' key in context
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start max-w-full">
        ...
        {selectedRule && (
          <aside className="w-full lg:w-80 space-y-4">
            <div className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/80 shadow-sm p-5">
