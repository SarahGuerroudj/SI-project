              ...
              <div className="space-y-4">
                <div className="bg-slate-800 p-6 rounded-2xl border border-slate-700 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">Project.SI@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:w-1/2 bg-slate-800/50 backdrop-blur-sm p-8 rounded-3xl border border-slate-700">
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <textarea rows={4} className="w-full bg-slate-900 border border-slate-700 rounded-xl p-3 text-white focus:border-lime-400 focus:outline-none transition-colors" placeholder="How can we help?" />
                </div>
      ...
      <footer className="bg-slate-950 py-12 border-t border-slate-900 text-center md:text-left">
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm mb-2">USTHB bab ezzouar</p>
            <p className="text-slate-400 text-sm">Project.SI@gmail.com</p>
          </div>
        </div>
